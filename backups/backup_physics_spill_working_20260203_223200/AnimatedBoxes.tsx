  ...
  return (
    <div className="relative px-0 py-0">
      <div className="min-h-[230px] relative">
        <div className="flex items-end gap-8 relative" style={{
          opacity: hasSpilledRef.current ? 0 : 1,
              ...
              <div className="absolute top-0 left-0 w-full h-[160px]">
                {allChips
                  ...
                  .map((chip, i) => {
                    ...
                    const isLanded = scrollProgress >= threshold
                    ...
                    return (
                      <motion.div
                        ...
                        animate={{
                          ...
                          x: bouncingBox === boxIndex && isLanded
